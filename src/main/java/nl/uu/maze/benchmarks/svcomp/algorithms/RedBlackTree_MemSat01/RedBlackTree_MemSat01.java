...
//
// For Maze it makes sense to target other public methods.
//
...
public class RedBlackTree_MemSat01 {
	
	 /** The root node of current tree. */
	  private RedBlackTreeNode root;

	  /** Constructs a new empty tree. */
	  public RedBlackTree_MemSat01() {
	    root = null;
	  }
	   ...
	   */
	  public RedBlackTree_MemSat01(RedBlackTreeNode x) {
	    root = x;
	  }
	  ...
	  public static boolean check(int[] ints) {
		  ...
		  try {
			  RedBlackTree_MemSat01 tree = new RedBlackTree_MemSat01();
			  int N = ints.length - 1 ;
			  for (int i = 0; i < N; i++) {
				  int data = ints[i] ;
			  ...
			  // should not throw any exception, so this point should not be reached
